...
namespace App\Libraries\Red2Horse\Adapter\Red2Horse\CodeIgniter\Throttle;
...
class Throttle extends Model
{
  ...
  private int $login_attempts = 0;
	...
	# --- Todo: change it to login_with_captcha = 5;
  ...
  protected $table = 'throttle';
	...
	# --- Todo: CacheAdapterInterface
	# --- Todo: DatabaseAdapterInterface
