...
function sqlFunctionInstance() : SqlClass
{
...
{
    return sqlFunctionInstance()->getTable( $key );
}

function getColumn ( string $key = 'user_group' )
{
    return sqlFunctionInstance()->getColumn( $key );
}

function getFields ( array $keys, string $table = 'user_group' )
{
    return sqlFunctionInstance()->getFields( $keys, $table );
}

/** @return mixed */
function getField ( string $key, string $table = 'user_group' )
{
    return sqlFunctionInstance()->getField( $key, $table );
}