...
class Crud extends Model
{
  ...
  {
		$this->validationRules['setting_name'] = 'min_length[5]|'
		. 'max_length[32]|alpha_dash|'
		. "is_unique[{$this->table}.setting_name]";
  ...
  public function setUpdateRules ( string $id )
  {
		$this->validationRules['setting_name'] = 'min_length[5]|'
		. 'max_length[32]|alpha_dash|'
		. "is_unique[{$this->table}.setting_name,setting_name,{$id}]";
